...
```bash
PYTHONIOENCODING=utf-8 python ${CLAUDE_SKILL_DIR}/../../ua.py stuck-check
```
...
1. Re-read these files from disk:
   - `${CLAUDE_SKILL_DIR}/../../skill/SKILL.md` (this file — the evolve protocol)
   - `${CLAUDE_SKILL_DIR}/../../meta_prompt.md` (MetaAgent instructions)
   - `${CLAUDE_SKILL_DIR}/../../program.md` (research directives)
